...
export class RegisterEventsService {
  ...
  editEvent(eventDetials: Object) {
    return this.http.patch<MsoEvent>(this.url + "/updateEvent", eventDetials);
  }
  ...
  changeEventStatusById(eventId: string) {
    alert("eventId: " +  eventId);
    return this.http.post<MsoEvent>(this.url + "/deactivateEventById/" + eventId, {} )
  };
}
